<div class="tabs-nav">
    <ul class="main-tabs" data-tab="tab-1">
        ...
        <?php endif; ?>
        <li id="tab-typo" ng-click="disableDrawMode();getResource('typography', '#tab-typography')" class="<?php if($product_data["option"]['admindesign'] == "0" ) echo 'active'; ?> tab animated slideInLeft animate500" ng-if="settings['nbdesigner_enable_text'] == 'yes'"><i class="icon-nbd icon-nbd-text" style="font-size: 21px"></i><span><?php _e('Text','web-to-print-online-designer'); ?></span></li>
