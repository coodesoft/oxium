                            ...
                            <table class="form-table">			
                                <tr valign="top">
                                    ...
                                    <td class="forminp-text">
                                        ...
                                        <div style="font-size: 11px; font-style: italic;"><?php _e('Allow extensions: svg, png, jpg, jpeg', 'web-to-print-online-designer'); ?><br /><?php _e('Allow upload multiple files.', 'web-to-print-online-designer'); ?></div>
                                    </td>
                                </tr>				
                            </table>
