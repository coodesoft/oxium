...
<div class="wrap nbdesigner-container">
                    ...
                    <div class="nbdesigner-content-left postbox">
                        ...
                        <div class="inside nbdesigner_font_info">						
                            ...
                            <table class="form-table">
                                <tr valign="top">
                                    <th scope="row" class="titledesc"><label for="font_name"><?php echo __("Font name", 'web-to-print-online-designer'); ?></label></th>
                                    <td class="forminp-text">
                                        <input id="font_name" style="min-width: 320px;" type="text" name="nbdesigner_font_name" placeholder="Henny Penny" value="<?php $name = isset($font_data->name) ?  $font_data->name : ''; echo $name; ?>" />
                                ...
                                <tr valign="top">
                                    <th scope="row" class="titledesc"><?php echo __("Font files", 'web-to-print-online-designer'); ?> </th>
                                    <td class="forminp-text">
                                        <?php 
                                        ...
                                        <div class="nbd-font-file-wrap">
                                            <p><label for="regular_font"><?php echo __("Regular", 'web-to-print-online-designer'); ?></label></p>
                                            ...
                                            <p style="font-family: <?php echo "'".$font_data->alias."', sans-serif"; ?>;font-size: 30px;"><?php echo $preview_text; ?></p>
                                            <?php endif; ?>
                                        </div>
                                        <div class="nbd-font-file-wrap">
                                            <p><label for="italic_font" style="font-style: italic;"><?php echo __("Italic", 'web-to-print-online-designer'); ?></label></p>
                                            ...
                                            ?>
                                            <style type='text/css'>
                                                @font-face {font-family: <?php echo $font_data->alias; ?>;src: local('☺'), url('<?php echo $url; ?>'); font-style: italic}
                                            </style>
                                            <p style="font-family: <?php echo "'".$font_data->alias."', sans-serif"; ?>;font-size: 30px;font-style: italic"><?php echo $preview_text; ?></p>
                                            <?php endif; ?>                                            
                                        </div> 
                                        <div class="nbd-font-file-wrap">
                                            <p><label for="bold_font" style="font-weight: bold;"><?php echo __("Bold", 'web-to-print-online-designer'); ?></label></p>
                                            ...
                                            ?>
                                            <style type='text/css'>
                                                @font-face {font-family: <?php echo $font_data->alias; ?>;src: local('☺'), url('<?php echo $url; ?>'); font-weight: bold}
                                            </style>
                                            <p style="font-family: <?php echo "'".$font_data->alias."', sans-serif"; ?>;font-size: 30px;font-weight: bold"><?php echo $preview_text; ?></p>
                                            <?php endif; ?>                                              
                                        </div>
                                        <div class="nbd-font-file-wrap">
                                            <p><label for="bold_italic_font" style="font-weight: bold;font-style: italic;"><?php echo __("Bold italic", 'web-to-print-online-designer'); ?></label></p>
                                            ...
                                            ?>
                                            <style type='text/css'>
                                                @font-face {font-family: <?php echo $font_data->alias; ?>;src: local('☺'), url('<?php echo $url; ?>'); font-style: italic; font-weight: bold}
                                            </style>
                                            <p style="font-family: <?php echo "'".$font_data->alias."', sans-serif"; ?>;font-size: 30px;font-style: italic; font-weight: bold"><?php echo $preview_text; ?></p>
                                            <?php endif; ?>                                              
                                        </div>
                                        <div style="font-size: 11px; font-style: italic;"><?php _e('Allow extensions: ttf', 'web-to-print-online-designer'); ?><br />
                                    </td>
                                </tr>
                                <tr valign="top">
                                    <th scope="row" class="titledesc"><label for="subset"><?php echo __("Font Language Subsets", 'web-to-print-online-designer'); ?></label></th>
                                    <td class="forminp-text">
	...
	<div class="postbox" id="nbd-list-fonts">
            <h3><?php echo __('List fonts ', 'web-to-print-online-designer'); ?>
                <?php if(is_array($cat) && (sizeof($cat) > 0)): ?>
                <select onchange="if (this.value) window.location.href=this.value+'#nbd-list-fonts'">
                    <option value="<?php echo admin_url('admin.php?page=nbdesigner_manager_fonts'); ?>"><?php _e('Select a category', 'web-to-print-online-designer'); ?></option>
                ...
                <?php  endif; ?>
                <!-- <a class="nbdesigner-right" href="<?php echo admin_url('admin.php?page=nbdesigner_manager_fonts'); ?>"><?php _e('All fonts', 'web-to-print-online-designer'); ?></a> -->
            </h3>
    ...
    <div class="postbox" ng-app='font-app' ng-controller="fontCtrl" ng-cloak>
        <div class="inside">
            ...
            <div class="gg-font-option">
                <input ng-model="filterFont.name" placeholder="Font name" ng-change="resetCurentPage()">
                ...
                <a class="button button-primary" ng-click="updateGoogleFont($event)"><?php _e('Update', 'web-to-print-online-designer');?></a>
            </div>          
                ...
                <div class="nbd-pagesize-wrap">
                    ...
                    <div style="display: inline-block; float: right;">
                        ...
                        <select id='nbd-selected' ng-model="filterFont.select" ng-change="resetCurentPage()">
                            ...
                            <option value="unselected"><?php _e('Unselected', 'web-to-print-online-designer');?></option>
                        </select>                         
                        <label for='nbd-page-size'><?php _e('Display ', 'web-to-print-online-designer');?></label>
                    ...
                    <div class="gg-font-preview" ng-repeat="font in fonts | startFrom:filterFont.currentPage*filterFont.pageSize | limitTo:filterFont.pageSize">
                        <div class="gg-font-preview-inner-wrap" style="font-family: '{{font.family}}',-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen-Sans, Ubuntu, Cantarell, 'Helvetica Neue', sans-serif">
                            <div class="gg-font-preview-inner">
                                ...
                                <span title="{{font.selected ? '<?php _e('Unselect', 'web-to-print-online-designer');?>' : '<?php _e('Select', 'web-to-print-online-designer');?>'}}" ng-class="font.selected ? '' : 'uncheck'" class="action dashicons dashicons-yes disable" ng-click="selectFont( font, $event )"></span>
                            </div>
                        </div>    
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    fontApp.directive('fontPagination', function(){
        return {
            ...
            template: '{{filterFont.totalPages}}<span ng-if="filterFont.currentPage > 0" ng-click="changePage(0)"><?php _e('First', 'web-to-print-online-designer');?></span><span ng-if="filterFont.currentPage > 1" ng-click="changePage(filterFont.currentPage-1)">{{filterFont.currentPage}}</span><span ng-click="changePage(filterFont.currentPage)" class="active">{{filterFont.currentPage + 1}}</span><span ng-if="filterFont.currentPage < (totalPages - 2)" ng-click="changePage(filterFont.currentPage+1)">{{filterFont.currentPage + 2}}</span><span ng-if="filterFont.currentPage < (totalPages - 1)" ng-click="changePage(totalPages-1)"><?php _e('Last', 'web-to-print-online-designer');?></span>',
            link: {
    ...
    fontApp.directive("fontOnLoad", ['$interval', function($interval) {
        return {
            ...
            link: function(scope, element) {
                ...
                element.append('<span class="font-loading"><?php _e('Loading...', 'web-to-print-online-designer');?></span>')
            }
        }
    }]);
</script>