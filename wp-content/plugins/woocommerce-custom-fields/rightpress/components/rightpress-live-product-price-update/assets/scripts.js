    ...
    jQuery('.rightpress_live_product_price').rightpress_live_product_update({
        ...
        response_handler: function(response) {
            ...
            if (typeof response === 'object' && typeof response.result !== 'undefined' && response.result === 'success' && response.display) {
                ...
                let price = '<span class="woocommerce-Price-currencySymbol">$</span>'+response.label_html;
                jQuery('.single_variation_wrap .woocommerce-Price-amount').html(price);
                
               
                // jQuery('.single_variation_wrap .woocommerce-Price-amount span')[0].nextSibling.nodeText = 'lalon';
                /*
